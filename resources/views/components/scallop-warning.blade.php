<div x-data="{ show: false }" class="relative inline-flex items-center">
    ...
    <div
        ...
        class="absolute bottom-full left-1/2 -translate-x-1/2 mb-2 w-64 bg-ink-900 text-ink-100 text-xs rounded-card px-3 py-2 shadow-lg z-50 pointer-events-none"
        role="tooltip"
    >
        ...
        <div class="absolute top-full left-1/2 -translate-x-1/2 border-4 border-transparent border-t-ink-900"></div>
    </div>
</div>
